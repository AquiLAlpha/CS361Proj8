...
public class ContextMenuController {
     ...
     */
    public void setupStyledJavaCodeAreaContextMenuHandler(StyledJavaCodeArea styledJavaCodeArea) {
        ContextMenu rightClickMenu = new ContextMenu();
     ...
     */
    public void setupConsoleContextMenuHandler(StyleClassedTextArea console, ReadOnlyBooleanProperty ifCompiling,
                                               ReadOnlyBooleanProperty ifCompilingRunning, BooleanBinding ifTabPaneEmpty) {
        ContextMenu rightClickMenu = new ContextMenu();
        ...
        StopItem.setOnAction(e -> this.toolbarController.handleStopButtonAction());

        // set binding for stopItem
        StopItem.disableProperty().bind(((ifCompiling.not()).and(ifCompilingRunning.not())).or(ifTabPaneEmpty));

        rightClickMenu.getItems().addAll(ClearAllItem, StopItem);
