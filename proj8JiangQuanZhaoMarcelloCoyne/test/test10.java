...
public class StyledJavaCodeArea extends CodeArea {
    ...
    /**
     * Constructor of StyledJavaCodeArea class
     */
    ...
    private void setAutoParenCompletion() {
        ...
        StyledJavaCodeArea thisCodeArea = this;
    ...
    public static void setKeywordColorClass(String keywordColorClass) {
        StyledJavaCodeArea.keywordColorClass = keywordColorClass;
    }
     ...
     */
    public static void setParenColorClass(String parenColorClass) {
        StyledJavaCodeArea.parenColorClass = parenColorClass;
    }
    ...
    public static void setStringColorClass(String stringColorClass) {
        StyledJavaCodeArea.stringColorClass = stringColorClass;
    }
     ...
     * @param intColorClass
     */
    public static void setIntColorClass(String intColorClass) {
        StyledJavaCodeArea.intColorClass = intColorClass;
    }

    /**
     * Appends a text to the StyledJavaCodeArea and highlights the text
     *
     * @param s String to append to the StyledJavaCodeArea
     */
